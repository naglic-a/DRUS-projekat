...
This is a small demo .NET 10 project that demonstrates secure client-server communication, failover mechanisms, and attack detection. This project simulates temperature sensors communicating with a central server via encrypted TCP connections.
...
- **Heartbeat Mechanism**: Sensors send periodic heartbeats to prove they're alive
